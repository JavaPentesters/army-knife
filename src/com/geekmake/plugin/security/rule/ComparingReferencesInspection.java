 ...
 * @version $Id: ComparingReferencesInspection.java v 0.1 2020/10/14 11:58 上午 pez1420 Exp $$
 */
...
public class ComparingReferencesInspection extends AbstractBaseJavaLocalInspectionTool {
    ...
    public static final String  QUICK_FIX_NAME  = "SDK: " + InspectionsBundle
        .message("inspection.comparing.references.use.quickfix");
    ...
    public PsiElementVisitor buildVisitor(@NotNull final ProblemsHolder holder,
        ...
        return new JavaElementVisitor() {
             ...
             */
            @NonNls
            private final String DESCRIPTION_TEMPLATE = "SDK " + InspectionsBundle
                .message("inspection.comparing.references.problem.descriptor");
    ...
    private static class CriQuickFix implements LocalQuickFix {
        ...
        public void applyFix(@NotNull Project project, @NotNull ProblemDescriptor descriptor) {
            try {
                ...
                PsiMethodCallExpression equalsCall = (PsiMethodCallExpression) factory
                    .createExpressionFromText("a.equals(b)", null);
