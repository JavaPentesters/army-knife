 ...
 * @version $Id: LinuxLogCommandDialog.java v 0.1 2020/3/26 7:02 下午 pez1420 Exp $$
 */
public class LinuxLogCommandDialog extends JDialog {
    ...
    public LinuxLogCommandDialog(Project project) {
    ...
    private void createUIComponents() {
        ...
        link0 = new ActionLink("", AllIcons.Ide.Link, new AnAction() {
            @Override
            public void actionPerformed(AnActionEvent anActionEvent) {
                BrowserUtil.browse(Constants.GITHUB_URL + "/docs/" + "linuxlog.md");
            }
        });
