...
public class JmapCommandDialog extends JDialog {
    ...
    private void initComponent() {
        copyCmdButton.addActionListener(e -> {
            ...
            if (selectedItem instanceof JmapCommandEnum) {
                selectedItemStr = ((JmapCommandEnum) selectedItem).getCode();
            }
        ...
        for (JmapCommandEnum value : JmapCommandEnum.values()) {
        ...
        comboBox.setRenderer(new DefaultListCellRenderer() {
            ...
            public Component getListCellRendererComponent(JList list, Object value, int index,
                ...
                if (value instanceof JmapCommandEnum) {
                    tipText = ((JmapCommandEnum) value).getMsg();
                    codeValue = ((JmapCommandEnum) value).getCode();
                }
                if (isSelected) {
