 ...
 * @version $Id: JstackCommandeDialog.java v 0.1 2020/3/26 7:02 下午 pez1420 Exp $$
 */
public class GcCommandDialog extends JDialog {
    ...
    public GcCommandDialog(Project project) {
    ...
    private void createUIComponents() {
        ...
        link1 = new ActionLink("", AllIcons.Ide.Link, new AnAction() {
            @Override
            public void actionPerformed(AnActionEvent anActionEvent) {
                BrowserUtil.browse(Constants.GITHUB_URL + "/docs/" + "gc.md");
            }
        });
